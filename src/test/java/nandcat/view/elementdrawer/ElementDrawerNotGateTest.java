...
public class ElementDrawerNotGateTest extends AbstractModuleElementDrawerTest {

    @Before
    public void setUp() {
        setUpForModuleClass(NotGate.class);
    }
