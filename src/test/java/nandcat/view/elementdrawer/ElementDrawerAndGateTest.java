...
public class ElementDrawerAndGateTest extends AbstractModuleElementDrawerTest {

    @Before
    public void setUp() {
        setUpForModuleClass(AndGate.class);
    }
