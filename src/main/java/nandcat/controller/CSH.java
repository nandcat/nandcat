/*
 * @(#)CSH.java 1.50 06/10/30 Copyright (c) 2006 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER OR REMOVE
 * COPYRIGHT NOTICES OR THIS FILE HEADER. This code is free software; you can redistribute it and/or modify it under the
 * terms of the GNU General Public License version 2 only, as published by the Free Software Foundation. Sun designates
 * this particular file as subject to the "Classpath" exception as provided by Sun in the LICENSE file that accompanied
 ...
 * Inc., 51 Franklin St, Fifth Floor, Boston, MA 02110-1301 USA. Please contact Sun Microsystems, Inc., 4150 Network
 * Circle, Santa Clara, CA 95054 USA or visit www.sun.com if you need additional information or have any questions.
 */
...
/**
 * A convenience class that provides simple access to context-senstive help functionality. It creates a default JavaHelp
 * viewer as well as ActionListeners for "Help" keys, on-item help, and help buttons.
 * 
...
public class CSH {
     ...
     * 
     * @param i
     *            index at which specified manager is to be inserted.
     * @param m
     *            the CSH manager
     * @exception ArrayIndexOutOfBoundsException
     *                index out of range (i &lt; 0 || i &gt;= CSH.getManagerCount()).
     * @since 2.0
     */
     ...
     * @exception ArrayIndexOutOfBoundsException
     *                index out of range (i &lt; 0 || i &gt;= CHS.getManagerCount()).
     * @since 2.0
     */
     ...
     * @exception ArrayIndexOutOfBoundsException
     *                index is out of range (i &lt; 0 || i &gt;= CSH.getManagerCount()).
     * @since 2.0
     */
     ...
     *                the runtime type of a manager is not a <code>CSH.Manager</code>
     * @since 2.0
     */
     ...
     *                comp is neither <code>Component</code> nor <code>MenuItem</code>.
     */
     ...
     * 
     * @exception IllegalArgumentException
     *                comp is neither <code>Component</code> nor
     */
    ...
    /**
     * Returns the dynamic HelpID for a object. The method passes the arguments into all registered CSH manageres to
     * obtain dynamic HelpID. If no manager provides HelpID for the object, the static HelpID is returned or traverse to
     * the component's ancestors for help.
     * 
     * @exception IllegalArgumentException
     *                comp is neither <code>Component</code> nor <code>MenuItem</code>.
     * @since 2.0
    ...
    /**
     * Returns the static helpID for a component. If the component doesn't have associated help, traverse the
    ...
    public static String getHelpIDString(Component comp) {
        ...
        /*
         * if (comp == null) { return null; } String helpID = _getHelpIDString(comp); // return the helpID if it exists
         * if (helpID != null) { return helpID; } // loop through the parents to try to find a valid helpID Component
         * parent = null; if (comp instanceof JPopupMenu) { parent = ((JPopupMenu)comp).getInvoker(); } else { parent =
         * comp.getParent(); } if (parent == null && parents != null) { parent = (Component)parents.get(comp); } if
         * (parent != null) { return getHelpIDString(parent); } else { return null; }
         */
    }

    /**
     * Returns the static helpID for a MenuItem. If the component doesn't have associated help, traverse the component's
     * ancestors for help.
     * <p>
     * 
     * This method calls <code>CSH.getHelpIDString(comp, null)</code>.
    ...
    public static String getHelpIDString(MenuItem comp) {
        ...
        /*
         * String helpID = _getHelpIDString(comp); // return the helpID if it exists if (helpID != null) { return
         * helpID; } // loop through the parents to try to find a valid helpID MenuContainer parent = comp.getParent();
         * if (parent instanceof MenuItem) { return getHelpIDString((MenuItem)parent); } else { return null; }
         */
    }
    ...
    /**
     * Returns the dynamic HelpSet for an object. HelpSets are stored in conjunction with helpIDs. It is possible for a
     * object to have a helpID without a HelpSet, but a object cannot have a HelpSet without a helpID. If the component
     * doesn't have an associated helpID, traverse the component's ancestors for a helpID. If the componet has a helpID
     * but doesn't have a HelpSet, return null.
     * 
     * @exception IllegalArgumentException
     *                comp is neither <code>Component</code> nor <code>MenuItem</code>.
     * 
    ...
    /**
     * Returns the static HelpSet for a Component. HelpSets are stored in conjunction with helpIDs. It is possible for a
     * Component to have a helpID without a HelpSet, but a Component cannot have a HelpSet without a helpID. If the
     * component doesn't have an associated helpID, traverse the component's ancestors for a helpID. If the componet has
     * a helpID but doesn't have a HelpSet, return null.
     * <p>
     * 
     ...
     * @see getHelpID
     * @exception IllegalArgumentException
     *                comp is not <code>Component</code
     */
    public static HelpSet getHelpSet(Component comp) {
        return getHelpSet(comp, null);

        /*
         * if (comp == null) { return null; } String helpID = _getHelpIDString(comp); if (helpID != null) { HelpSet hs =
         * _getHelpSet(comp); if (hs != null) { return hs; } } Component parent = null; if (comp instanceof JPopupMenu)
         * { parent = ((JPopupMenu)comp).getInvoker(); } else { parent = comp.getParent(); } if (parent == null &&
         * parents != null) { parent = (Component)parents.get(comp); } if (parent != null) { return getHelpSet(parent);
         * } else { return null; }
         */
    }

    /**
     * Returns the static HelpSet for a MenuItem. HelpSets are stored in conjunction with helpIDs. It is possible for a
     * MenuItem to have a helpID without a HelpSet, but a MenuItem cannot have a HelpSet without a helpID. If the
     * component doesn't have an associated helpID, traverse the component's ancestors for a helpID. If the componet has
     * a helpID, but doesn't have a HelpSet return null.
     * 
     * This method calls <code>CSH.getHelpIDString(comp, null)</code>.
     * 
     * @exception IllegalArgumentException
     *                comp is not <code>MenuItem</code>
     * 
     * @see getHelpID
     */
    public static HelpSet getHelpSet(MenuItem comp) {
        ...
        /*
         * if (comp == null) { return null; } String helpID = _getHelpIDString(comp); if (helpID != null) { HelpSet hs =
         * _getHelpSet(comp); if (hs != null) { return hs; } } MenuContainer parent = comp.getParent(); if (parent
         * instanceof MenuItem) { return getHelpSet((MenuItem)parent); } else { return null; }
         */
    }
     ...
     * 
     * @return Object The object on which the event occurred. Null if cancelled on an undetermined object.
     */
     ...
     * @param hb The HelpBroker to display in. Can be null but hs and and presentation must be supplies
     ...
     * @param presentationName The named presentation to modify the Presentation class with. In some Presenations this
     * is also a "named" Presentation.
    ...
    /*
     * private static Rectangle getRectangleAt(JComboBox combo, int x, int y) { return combo.getBounds(); } private
     * static Component getComponentAt(JComboBox combo, int x, int y) { try{ if (combo.isEditable()) { return null; }
     * Object value = combo.getSelectedItem(); boolean hasFocus = combo.hasFocus() && !combo.isPopupVisible(); // How to
     * get JList for getListCellRendererComponent()? // That's the question... JList list = new JList(); return
     * combo.getRenderer().getListCellRendererComponent( list, value, -1, hasFocus, false); } catch (Exception e) {
     * return null; } }
     */

    /**
     * An ActionListener that displays the help of the object that currently has focus. This method is used to enable
     * HelpKey action listening for components other than the RootPane. This listener determines if the object with the
     * current focus has a helpID. If it does, the helpID is displayed, otherwise the helpID on the action's source is
    ...
    public static class DisplayHelpFromFocus implements ActionListener {
        ...
        /**
         * Create a DisplayHelpFromFocus actionListener for a given HelpSet. Display the results in specific
    ...
    private static JPopupMenu getRootPopupMenu(JPopupMenu popup) {
        while ((popup != null) && (popup.getInvoker() instanceof JMenu)
    ...
    /**
     * Returns the deepest focused Component or the deepest JPopupMenu or the deepest armed MenuItem from JPopupMenu
     * hierarchy.
     */
    ...
    /**
     * Returns the child component which has focus with respects of PopupMenu visibility.
     */
    ...
    public static class DisplayHelpFromSource implements ActionListener {
        ...
        /**
         * Create a DisplayHelpFromSource actionListener for a given HelpSet. Display the results in specific
         * Presentation of given PresentationName.
         * 
         * @param hs
         *            A valid HelpSet.
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            displayHelp(hb, hs, presentation, presentationName, source, source, e);

        }
    }

    /**
     * CSH Manager Interface to support dynamic <code>HelpSet</code> and <code>ID</code> for object. CSH is allowed only
     * for <code>Component</code> and <code>MenuItem</code>.
     * 
     * @since 2.0
     */
    public interface Manager {
         ...
         * 
         * @param comp
         *            The object to get <code>HelpSet</code> for it. Only <code>Component</code> and
         *            <code>MenuItem</code> is allowed.
         * @param e
         *            The event by which dynamic CSH was invoked. It can be <code>MouseEvent</code> in case of window
         *            level CSH, <code>ActionEvent</code> in case of field level CSH or <code>null</code> otherwise.
         ...
         * 
         * @param comp
         *            The object to get <code>Map.ID</code> for it. Only <code>Component</code> and
         *            <code>MenuItem</code> is allowed.
         * @param e
         *            The event by which dynamic CSH was invoked. It can be <code>MouseEvent</code> in case of window
         *            level CSH, <code>ActionEvent</code> in case of field level CSH or <code>null</code> otherwise.
